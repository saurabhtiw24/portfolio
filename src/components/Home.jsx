...
import pic from "../../src/assets/IMG1.jpg"
  ...
  return (
    ...
    <div className='max-w-screen-2xl container mx-auto px-4 md:px-20 my-20'>
        <div className='flex flex-col md:flex-row'>
            ...
            I am a web developer currently working in frontend technologies and recently graduated from Jaypee 
            University of Engineering and Technology in February 2020.
